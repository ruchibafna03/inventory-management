...
type AccountMaster struct {
	...
	SubCode sql.NullString  `db:"sub_code" json:"sub_code,omitempty"`
	Desc    string          `db:"desc"     json:"desc"`
	AName   sql.NullString  `db:"a_name"   json:"a_name,omitempty"`
	Amt     float64         `db:"amt"      json:"amt"`
	Rmk     sql.NullString  `db:"rmk"      json:"rmk,omitempty"`
	Rate    float64         `db:"rate"     json:"rate"`
	Per     float64         `db:"per"      json:"per"`
	Opb     float64         `db:"opb"      json:"opb"`
	Date    sql.NullTime    `db:"date"     json:"date,omitempty"`
	Cat     sql.NullString  `db:"cat"      json:"cat,omitempty"`
	Dia     sql.NullString  `db:"dia"      json:"dia,omitempty"`
	GCode   sql.NullString  `db:"g_code"   json:"g_code,omitempty"`
}

type AddressMaster struct {
	ACCode string         `db:"ac_code" json:"ac_code"`
	Add1   sql.NullString `db:"add1"    json:"add1,omitempty"`
	Add2   sql.NullString `db:"add2"    json:"add2,omitempty"`
	Add3   sql.NullString `db:"add3"    json:"add3,omitempty"`
	Pin    sql.NullString `db:"pin"     json:"pin,omitempty"`
	TelR1  sql.NullString `db:"tel_r1"  json:"tel_r1,omitempty"`
	TelO1  sql.NullString `db:"tel_o1"  json:"tel_o1,omitempty"`
	Mobile sql.NullString `db:"mobile"  json:"mobile,omitempty"`
	Lst    sql.NullString `db:"lst"     json:"lst,omitempty"`
	Cst    sql.NullString `db:"cst"     json:"cst,omitempty"`
	PanNo  sql.NullString `db:"panno"   json:"panno,omitempty"`
	TinNo  sql.NullString `db:"tinno"   json:"tinno,omitempty"`
}
...
type Item struct {
	...
	SetCode    sql.NullString `db:"set_code"   json:"set_code,omitempty"`
	Desc       string         `db:"desc"       json:"desc"`
	Fac        float64        `db:"fac"        json:"fac"`
	Stamp      sql.NullString `db:"stamp"      json:"stamp,omitempty"`
	Purity     sql.NullString `db:"purity"     json:"purity,omitempty"`
	...
	Stn1Name   sql.NullString `db:"stn1_name"  json:"stn1_name,omitempty"`
	Stn1Ct     float64        `db:"stn1_ct"    json:"stn1_ct"`
	Stn1Gm     float64        `db:"stn1_gm"    json:"stn1_gm"`
	Stn2Name   sql.NullString `db:"stn2_name"  json:"stn2_name,omitempty"`
	Stn2Ct     float64        `db:"stn2_ct"    json:"stn2_ct"`
	Stn2Gm     float64        `db:"stn2_gm"    json:"stn2_gm"`
	Stn3Name   sql.NullString `db:"stn3_name"  json:"stn3_name,omitempty"`
	...
	Prl1Name   sql.NullString `db:"prl1_name"  json:"prl1_name,omitempty"`
	...
	Prl2Name   sql.NullString `db:"prl2_name"  json:"prl2_name,omitempty"`
	Prl2Gm     float64        `db:"prl2_gm"    json:"prl2_gm"`
	Prl3Name   sql.NullString `db:"prl3_name"  json:"prl3_name,omitempty"`
	Prl3Gm     float64        `db:"prl3_gm"    json:"prl3_gm"`
	Narr1      sql.NullString `db:"narr1"      json:"narr1,omitempty"`
	Narr2      sql.NullString `db:"narr2"      json:"narr2,omitempty"`
	MkChrg     float64        `db:"mk_chrg"    json:"mk_chrg"`
	WPer       float64        `db:"w_per"      json:"w_per"`
	RecptDate  sql.NullTime   `db:"recpt_date" json:"recpt_date,omitempty"`
	LotNo      sql.NullString `db:"lot_no"     json:"lot_no,omitempty"`
	IssueNo    sql.NullString `db:"issue_no"   json:"issue_no,omitempty"`
	IssueDate  sql.NullTime   `db:"issue_date" json:"issue_date,omitempty"`
	ACCode     sql.NullString `db:"ac_code"    json:"ac_code,omitempty"`
	StkCode    sql.NullString `db:"stk_code"   json:"stk_code,omitempty"`
	Cat        sql.NullString `db:"cat"        json:"cat,omitempty"`
	Kp         sql.NullString `db:"kp"         json:"kp,omitempty"`
	Tag        sql.NullString `db:"tag"        json:"tag,omitempty"`
	Cat1       sql.NullString `db:"cat1"       json:"cat1,omitempty"`
	Cna        sql.NullString `db:"cna"        json:"cna,omitempty"`
	Exb        sql.NullString `db:"exb"        json:"exb,omitempty"`
...
type Lot struct {
	...
	ACCode    sql.NullString `db:"ac_code"     json:"ac_code,omitempty"`
	Party     sql.NullString `db:"party"       json:"party,omitempty"`
	...
	Desc      sql.NullString `db:"desc"        json:"desc,omitempty"`
}
...
type Issue struct {
	TNo       string         `db:"t_no"        json:"t_no"`
	TNo1      sql.NullString `db:"t_no1"       json:"t_no1,omitempty"`
	Pre       sql.NullString `db:"pre"         json:"pre,omitempty"`
	TDate     time.Time      `db:"t_date"      json:"t_date"`
	DueDate   sql.NullTime   `db:"due_date"    json:"due_date,omitempty"`
	ACCode    sql.NullString `db:"ac_code"     json:"ac_code,omitempty"`
	ACCode1   sql.NullString `db:"ac_code1"    json:"ac_code1,omitempty"`
	Tag       sql.NullString `db:"tag"         json:"tag,omitempty"`
	...
	Rate      float64        `db:"rate"        json:"rate"`
	Narr      sql.NullString `db:"narr"        json:"narr,omitempty"`
	Narr1     sql.NullString `db:"narr1"       json:"narr1,omitempty"`
	Desc      sql.NullString `db:"desc"        json:"desc,omitempty"`
	BillAmt   float64        `db:"bill_amt"    json:"bill_amt"`
	Tc        sql.NullString `db:"tc"          json:"tc,omitempty"`
	Exb       sql.NullString `db:"exb"         json:"exb,omitempty"`
	CreatedAt time.Time      `db:"created_at"  json:"created_at"`
	UpdatedAt time.Time      `db:"updated_at"  json:"updated_at"`
	// Joined details
	...
	// Joined party name
	PartyName sql.NullString `db:"party_name"  json:"party_name,omitempty"`
}

type IssueDetail struct {
	ID        int            `db:"id"         json:"id"`
	TNo       string         `db:"t_no"       json:"t_no"`
	TDate     sql.NullTime   `db:"t_date"     json:"t_date,omitempty"`
	RecptNo   sql.NullString `db:"recpt_no"   json:"recpt_no,omitempty"`
	RecptDate sql.NullTime   `db:"recpt_date" json:"recpt_date,omitempty"`
	ItCd      sql.NullString `db:"itcd"       json:"itcd,omitempty"`
	ACCode    sql.NullString `db:"ac_code"    json:"ac_code,omitempty"`
	ItDesc    sql.NullString `db:"itdesc"     json:"itdesc,omitempty"`
	Nos       float64        `db:"nos"        json:"nos"`
	GrossWt   float64        `db:"gross_wt"   json:"gross_wt"`
	KundnWt   float64        `db:"kundn_wt"   json:"kundn_wt"`
	NakashWt  float64        `db:"nakash_wt"  json:"nakash_wt"`
...
type Sale struct {
	...
	OvNo      sql.NullString `db:"ovno"        json:"ovno,omitempty"`
	Pre       sql.NullString `db:"pre"         json:"pre,omitempty"`
	VouchNo1  sql.NullString `db:"vouch_no1"   json:"vouch_no1,omitempty"`
	VouchDate time.Time      `db:"vouch_date"  json:"vouch_date"`
	ACCode    sql.NullString `db:"ac_code"     json:"ac_code,omitempty"`
	Name      sql.NullString `db:"name"        json:"name,omitempty"`
	Add1      sql.NullString `db:"add1"        json:"add1,omitempty"`
	Add2      sql.NullString `db:"add2"        json:"add2,omitempty"`
	PhoneNo   sql.NullString `db:"phone_no"    json:"phone_no,omitempty"`
	PhoneNo1  sql.NullString `db:"phone_no1"   json:"phone_no1,omitempty"`
	Sman      sql.NullString `db:"sman"        json:"sman,omitempty"`
	Nos       int            `db:"nos"         json:"nos"`
	GrossWt   float64        `db:"gross_wt"    json:"gross_wt"`
	KundnWt   float64        `db:"kundn_wt"    json:"kundn_wt"`
	NakashWt  float64        `db:"nakash_wt"   json:"nakash_wt"`
	...
	Narr      sql.NullString `db:"narr"        json:"narr,omitempty"`
	Narr1     sql.NullString `db:"narr1"       json:"narr1,omitempty"`
	BType     sql.NullString `db:"btype"       json:"btype,omitempty"`
	CreatedAt time.Time      `db:"created_at"  json:"created_at"`
	UpdatedAt time.Time      `db:"updated_at"  json:"updated_at"`
}
...
type Purchase struct {
	...
	Rmk       sql.NullString `db:"rmk"        json:"rmk,omitempty"`
	Tag       sql.NullString `db:"tag"        json:"tag,omitempty"`
	Post      sql.NullString `db:"post"       json:"post,omitempty"`
	CreatedAt time.Time      `db:"created_at" json:"created_at"`
}
